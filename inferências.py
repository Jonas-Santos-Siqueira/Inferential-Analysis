...
"""###APARTI DE AGORA, COMEÇA UMA VISUALIZAÇÃO DE VARIÁVEIS. - PARTE 2. (Opcional)

Irei visualizar as Variáveis "DPQ010", "DPQ020", "DPQ030", "DPQ040", "DPQ050", "DPQ060", "DPQ070", "DPQ080", "DPQ090".

Motivo: São situações que causam um maior impacto na observação da ocilação de humor das pessoas que responderam as variáveis "DPQ010" a "DPQ090".
"""

plot(jt, "DPQ010")

# Pelo visto, 9,3% se recusou a responder (unico grupo que não aparece no plot).
# O Grupo que tem mais Frequency é o "0", isso mostra que muitos estão bem em relação a essa situação.
# O segundo grupo com mais Frenquency é o "1", onde nos mostra que 12,6% teve pouco interesse diante a situação abordada na variavel "DPQ010".
...
"""Agora vamos de Grupo de Aderência."""

plot(jt, "ADHERENCE")

# Podemos ver no "Value Table" que a maior frequencia está no "1.0", onde está abaixo do adequado na realização de exercicios.
